...
export class ReloadCommand extends BaseCommand {
  ...
  get description(): string { return '重载指定的 CLI 项目'; }
  ...
  private async handleReload(key?: string, options?: Record<string, unknown>): Promise<void> {
    const reloadAll = options?.all as boolean;
